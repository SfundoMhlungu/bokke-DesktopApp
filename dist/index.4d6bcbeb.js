...
})({"2s5bM":[function(require,module,exports) {
"use strict";
...
var _bokkeJs = require("bokke.js");
var _bokkeJsDefault = parcelHelpers.interopDefault(_bokkeJs);
var _utils = require("./utils");
var _toolbar = require("./components/toolbar");
var _gui = require("./components/gui");
var _table = require("./components/table");
var _pubSub = require("./pubSub");
var _toolsSub = require("./components/subs/toolsSub");
var _createElSub = require("./components/subs/createElSub");
// dom cache
const cache = {};
console.log((0, _pubSub.Pub));
const app = document.getElementById("app");
const header = document.getElementById("header");
const toolsUnsub = (0, _toolsSub.toolSub)((0, _pubSub.Pub), app, cache);
const createElUnsub = (0, _createElSub.createElSub)((0, _pubSub.Pub), app, cache);
//console.log(Pub)
const toggleB = (r)=>{
    if (r === "Gui") (0, _pubSub.Pub).notify("router", "Gui");
    else (0, _pubSub.Pub).notify("router", "Ed");
};
//  f.onchange = () => {
...
//    })
//}
(0, _utils.clearEl)(header);
header.appendChild((0, _utils.createElement)((0, _toolbar.toolbar)(toggleB)));
(0, _utils.clearEl)(app);
// no need for defclaration(to help me remember)
cache["GUITools"] = (0, _utils.createElement)((0, _gui.tools)((0, _pubSub.Pub)));
app.appendChild(cache["GUITools"]);
let f = document.getElementById("f");
f.addEventListener("change", ()=>(0, _pubSub.Pub).notify("tools", "file", f));
let routerUnsub = (0, _pubSub.Pub).subcribe("router", (...data)=>{
    switch(data[0]){
        case "Gui":
            (0, _utils.clearEl)(app);
            console.log(cache);
            if (!cache["app"]) {
                app.appendChild((0, _utils.createElement)((0, _gui.tools)((0, _pubSub.Pub))));
                cache["app"] = app.innerHTML;
            } else {
                console.log("appending cache");
        ...
        case "Ed":
            (0, _utils.clearEl)(app);
            console.log("switch to ed");
            break;
        default:
            break;
    }
}) // todo remove tools from app
 // caching messes them up
;

},{"bokke.js":"dqDZC","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku","./utils":"en4he","./components/toolbar":"15V4i","./components/gui":"bA5Dk","./pubSub":"bMumQ","./components/table":"geu6O","./components/subs/toolsSub":"cjoYh","./components/subs/createElSub":"d4mCV"}],"dqDZC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Hist", ()=>(0, _histDefault.default));
parcelHelpers.export(exports, "Plot", ()=>(0, _independentPlotsDefault.default));
var _dataFrame = require("./dataFrame");
var _dataFrameDefault = parcelHelpers.interopDefault(_dataFrame);
var _hist = require("./hist");
var _histDefault = parcelHelpers.interopDefault(_hist);
var _independentPlots = require("./independentPlots");
var _independentPlotsDefault = parcelHelpers.interopDefault(_independentPlots);
exports.default = (0, _dataFrameDefault.default);

},{"./dataFrame":"1yTmA","./hist":"8zqJo","./independentPlots":"5xvI1","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"1yTmA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function dataFrame(file, tableReady, headers = []) {
    ...
    } else if (typeof file === "string") // url
    fetchFile(file);
}
exports.default = dataFrame;
function readFile(file, headers) {
    const work = new Worker(require("1b4f60212ab10084"));
...
function toTable(data) {
    ...
    const work = new Worker(require("a2d513857317b8fe"));
    work.postMessage({
        data: data
    });
    work.onmessage = (e)=>{
        let frame = new (0, _frameDefault.default)(e.data, data);
        //  console.log(frame)
...
},{"./frame":"cvn85","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku","1b4f60212ab10084":"fzRHf","a2d513857317b8fe":"bzZtU"}],"cvn85":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _frameFuntions = require("./frameFuntions");
var _plots = require("./plots");
var _stats = require("./stats");
var _mainHelpers = require("./mainHelpers");
class Frame {
    constructor(table, data){
        ...
        } else this.Header_ = this.Pdata.header_;
    }
    get shape() {
        return [
            this.Pdata.data.length,
            this.Pdata.data[0].length
        ];
    }
    get columns() {
        return this.Header_;
...
Frame.prototype.returnFrame = (0, _frameFuntions.returnFrame);
Frame.prototype.head = (0, _frameFuntions.head);
Frame.prototype.tail = (0, _frameFuntions.tail);
Frame.prototype.map = (0, _frameFuntions.map);
Frame.prototype.slice = (0, _frameFuntions.slice);
Frame.prototype.isNull = (0, _frameFuntions.isNull);
Frame.prototype.query = (0, _frameFuntions.query);
Frame.prototype.drop = (0, _frameFuntions.drop);
Frame.prototype.dropna = (0, _frameFuntions.dropna);
Frame.prototype.replace = (0, _frameFuntions.replace);
Frame.prototype.unique = (0, _frameFuntions.unique);
Frame.prototype.getCol = (0, _frameFuntions.getCol);
Frame.prototype.apply_along_axis = (0, _frameFuntions.apply_along_axis);
Frame.prototype.counter = (0, _frameFuntions.count);
Frame.prototype.rename = (0, _frameFuntions.rename);
Frame.prototype.reset = (0, _frameFuntions.resetIndex);
...
//plots 
Frame.prototype.hist = (0, _plots.plot_histogram);
Frame.prototype.scatterM = (0, _plots.make_scatter_matrix);
Frame.prototype.scatter = (0, _plots.twoD);
Frame.prototype.validate = function() {
    let status = {
        status: true
    };
    // this.Pdata.data.forEach((arr:Array<any>,i:number)=> {
    for (let i of (0, _mainHelpers.range)(this.Pdata.data.length)){
        let arr = this.Pdata.data[i];
        for (let j of arr)if (typeof j === "string") {
            status.status = false;
            status.rowNcol = {
                i,
                j
...
Frame.prototype.group_by = (0, _frameFuntions.group_by);
Frame.prototype.newCol = function(arr, header, type, callback) {
    if (arr.length !== this.Pdata.data.length) throw new Error("new column length !== dataframe len");
    else {
...
Frame.prototype.basicStat = (0, _stats.workerMean);
Frame.prototype.writeCSV = (0, _frameFuntions.writeCsv);
Frame.prototype.swap = (0, _frameFuntions.change);
Frame.prototype.appendRow = (0, _frameFuntions.appendRow); // function fillna(method, inplace)
...
},{"./frameFuntions":"dCL6H","./plots":"520zh","./stats":"jixf9","./mainHelpers":"5zkm6","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"dCL6H":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "returnFrame", ()=>returnFrame);
...
parcelHelpers.export(exports, "getCol", ()=>getCol);
// return a new frame 
parcelHelpers.export(exports, "rename", ()=>rename);
parcelHelpers.export(exports, "drop", ()=>drop);
parcelHelpers.export(exports, "dropna", ()=>dropna);
parcelHelpers.export(exports, "replace", ()=>replace);
parcelHelpers.export(exports, "apply_along_axis", ()=>apply_along_axis);
// group By 
parcelHelpers.export(exports, "group_by", ()=>group_by);
// count values in a column 
parcelHelpers.export(exports, "count", ()=>count);
parcelHelpers.export(exports, "resetIndex", ()=>resetIndex);
parcelHelpers.export(exports, "writeCsv", ()=>writeCsv);
parcelHelpers.export(exports, "change", ()=>change);
parcelHelpers.export(exports, "appendRow", ()=>appendRow);
var _frame = require("./frame");
var _frameDefault = parcelHelpers.interopDefault(_frame);
var _series = require("./series");
var _seriesDefault = parcelHelpers.interopDefault(_series);
var _helpers = require("./workers/helpers");
function returnFrame(obj, data, headers, inPlace, callback, meta) {
    //    console.log("return frame called")
    if (inPlace) {
        const work = new Worker(require("cbe4961d42ee655b"));
        work.postMessage(obj);
        work.onmessage = (e)=>{
            ...
            this.Pdata.header_ = headers;
            this.Header_ = headers;
            if (meta) this.Pdata.meta = meta;
            callback(this);
            work.terminate();
        };
    } else {
        const work1 = new Worker(require("cbe4961d42ee655b"));
        work1.postMessage(obj);
        work1.onmessage = (e)=>{
            let dataCopy = JSON.parse(JSON.stringify(data));
            let data_ = JSON.parse(JSON.stringify(this.Pdata));
            // console.log(dataCopy)
            data_.data = dataCopy;
            if (meta) data_.meta = meta;
            data_.header_ = headers;
            //  dataCopy.header_ = headers
            //  dataCopy.Header_ = headers
            callback(new (0, _frameDefault.default)(e.data, data_));
            work1.terminate();
        };
    }
}
function map(values, column, callback, inPlace = false) {
    ...
    index = headers.indexOf(column);
    data.forEach((arr, i)=>{
        if (values[arr[index]]) arr[index] = values[arr[index]];
    });
    let obj = {
        data: {
            data: data,
...
function slice(start, end, callback) {
    ...
    `);
    const work = new URL(require("eb30d4f9d7fe3d70"));
    // //.log(this.Pdata.)
    let headers = JSON.parse(JSON.stringify(this.Header_));
...
function isNull(callback, column) {
    ...
    if (column) {
        ...
        if (index !== -1) {
            data.forEach((val, index2)=>{
                ...
                //.log(val[index])
                temp[0] = index2;
                if (val[index] === "NaN") temp.push(true);
        ...
        //.log(truthTable) 
        } else throw new Error(`${column} does not exist`);
    } else {
    ...
    let handler = {
        get (target, key) {
            if (key.split(",").length > 2) {
                ...
                let temp2 = [];
                key.split(",").forEach((val)=>{
                    if (Number(val)) temp.push(data[+val]);
                    else {
                        const index = this.Header_.indexOf(val);
                        let temp3 = [];
                        if (index !== -1) this.Pdata.data.forEach((val, index)=>{
                            temp3.push(val[index]);
                        });
                        temp2.push(temp3);
                        temp3 = [];
                ...
                if (temp.length > 0 && temp2.length > 0) return [
                    temp,
                    temp2
                ];
                else if (temp2.length > 0) return temp2;
                else if (temp.length > 0) return temp;
                else throw new Error(key + "  Query Failed column or row does not exist");
            } else if (Number(key)) return data[key];
            else if (typeof key === "string") {
                //.log(key, "Object")
                const index = this.Header_.indexOf(key);
                let temp3 = [];
...
function unique(column) {
    ...
    this.Pdata.data.forEach((arr, i)=>{
        if (!unique.includes(arr[index])) unique.push(arr[index]);
    });
    return unique;
}
function getCol(column) {
    let index = this.Header_.indexOf(column);
    let col = [];
    if (index >= 0) this.Pdata.data.forEach((arr, i)=>{
        col.push(arr[index]);
    });
    else throw new Error(`${column} probably does not exist`);
    return new (0, _seriesDefault.default)(col, [], this.Pdata.meta[index]);
}
function rename(oldval, value, callback) {
    let index = this.Header_.indexOf(oldval);
    if (index !== -1) this.Header_[index] = value;
    let obj = {
        data: {
            data: this.Pdata.data,
            header_: this.Header_,
...
function drop(inPlace = false, callback, ...values) {
    ...
    let meta = undefined;
    values.forEach((val)=>{
        if (Number(val)) //    data.splice(val, 1)
        //    data.forEach((arr, index)=> {
        //     arr[0] = index
        // })
        indices.push(val);
        else if (val === 0 || val === "0") // data.splice(val, 1)
        // data.forEach((arr, index)=> {
        //     arr[0] = index
        // })
        indices.push(val);
            ...
            if (typeof val === "string") {
                ...
                if (indice !== -1) {
                    ...
                    if (res) {
                        ...
                        let newObj = {};
                        for (let key of k)if (indice < +key) {
                            let newKey = +key - 1;
                            newObj[newKey] = metacopy[key];
                        } else newObj[key] = metacopy[key];
                        meta = newObj;
                    }
                } else throw new Error(`${val} column does not exist`);
            } else throw new Error(`${val} type not implemented`);
        }
    });
    let index = 0;
    indices.forEach((val)=>{
...
function dropna(inPlace = false, callback) {
    let headers = JSON.parse(JSON.stringify(this.Header_));
    let data = JSON.parse(JSON.stringify(this.Pdata.data));
    for(let i = data.length - 1; i >= 0; i--)if (data[i].includes("NaN")) data.splice(i, 1);
    // data.forEach((arr, index)=> {
    //     arr[0] = index
    // })
    let obj = {
...
function apply_along_axis(axis, fn, where, callback, inPlace = false) {
    ...
    if (axis === 1) {
        let index = headers.indexOf(where);
        if (index !== -1) data.forEach((arr, i)=>{
            arr[index] = fn(arr[index]);
        });
        else throw new Error(`${where} does not exist, i think`);
    } else if (axis === 0) {
        // row 
        if (where === "all") // for all rows
        data.forEach((arr, i)=>{
            arr.forEach((val, j)=>{
                arr[j] = fn(val);
            });
...
function group_by(column, predicateFn, callback) {
    ...
    let group = [];
    if (index !== -1) data.forEach((arr, index_)=>{
        let val = arr[index];
        if (typeof val === "string") val = val.trim();
        if (predicateFn(val)) group.push(arr);
    });
    else throw new Error(`${column} does not exist, i think.`);
    // console.log(group)
    let obj = {
        data: {
            data: group,
...
function count(column) {
    ...
    if (col) count = (0, _helpers.counter)(col.data);
    return count;
}
...
function change(rowIndex, row, callback) {
    if (rowIndex <= this.Pdata.data.length) this.Pdata.data[rowIndex] = row;
    else throw new Error(`${rowIndex} is out of range`);
    let obj = {
        data: {
            data: this.Pdata.data,
            header_: this.Header_,
...
function appendRow(array, callback) {
    array.unshift(this.Pdata.data.length);
    if (array.length === this.Pdata.data[0].length) this.Pdata.data.push(array);
    else throw new Error(`${array} has insufficient columns: expected ${this.Pdata.data[0].length} but got ${array.length}`);
    let obj = {
        data: {
            data: this.Pdata.data,
            header_: this.Header_,
...
},{"./frame":"cvn85","./series":"ZGQ0H","./workers/helpers":"cMxE7","eb30d4f9d7fe3d70":"ccpTo","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku","cbe4961d42ee655b":"bzZtU"}],"ZGQ0H":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Series {
...
},{}],"cMxE7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function isDate(val) {
    let x = new Date(val);
    if (x instanceof Date && !isNaN(x)) return true;
    else return false;
}
    ...
    return {
        ...
        take () {
            return new Promise((resolveTake)=>{
                if (puts.length > 0) resolveTake(puts.shift()());
                else takes.push(resolveTake);
            });
        }
    };
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"ccpTo":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("gnRNX") + "tableworker.b5dec1d7.js" + "?" + Date.now();

},{"./helpers/bundle-url":"28iTF"}],"28iTF":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"bzZtU":[function(require,module,exports) {
let workerURL = require("./helpers/get-worker-url");
let bundleURL = require("./helpers/bundle-url");
let url = bundleURL.getBundleURL("gnRNX") + "tableworker.bcd66dbe.js" + "?" + Date.now();
...
},{}],"520zh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "make_histogram", ()=>make_histogram);
parcelHelpers.export(exports, "plot_histogram", ()=>plot_histogram);
// chart matrix 
parcelHelpers.export(exports, "make_scatter_matrix", ()=>make_scatter_matrix);
parcelHelpers.export(exports, "twoD", ()=>twoD);
...
(0, _chartJs.Chart).register((0, _chartJs.BarController), (0, _chartJs.CategoryScale), (0, _chartJs.LinearScale), (0, _chartJs.BarElement), (0, _chartJs.ScatterController), (0, _chartJs.PointElement), (0, _chartJs.LineElement));
// console.log(Chart)
// one dimensional
...
function make_histogram(data, bucket_size) {
    return new Promise((resolve, reject)=>{
        const work = new Worker(require("7e126c47f8f88c31"));
        work.postMessage({
            type: "hist",
            points: data,
            size: bucket_size
        ...
        work.onmessage = (e)=>{
            if (e.data.status === "fail") reject(e.data.reason);
            else resolve(e.data.hist);
        };
    });
}
function plot_histogram(bucket_size, title = "", data) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        barChart = new (0, _chartJs.Chart)(c.id, {
            type: "bar",
            data: dataObj
        });
    });
...
function make_scatter_matrix(elementId) {
    ...
    let str = "";
    for (let _ of (0, _mainHelpers.range)(num_columns))str += " 1fr";
    console.log(str);
    ...
    for (let i of (0, _mainHelpers.range)(num_columns))for (let j of (0, _mainHelpers.range)(num_columns))make_scatter_chart((0, _mainHelpers.getCol)(data, i), (0, _mainHelpers.getCol)(data, j), i, j, elementId);
}
function make_scatter_chart(x, y, i, j, elementId) {
    const dataObj = {
        datasets: [
            {
                data: (0, _mainHelpers.zipToObj)(x, y),
                label: `${i} ${j}`,
                pointRadius: 4,
    ...
    div.appendChild(c);
    el === null || el === void 0 || el.appendChild(div);
    scatter.push(new (0, _chartJs.Chart)(c, chartObj));
}
let two = undefined;
function twoD(xs, colors, ...ys) {
    ...
    let points = [];
    ys.forEach((ys1)=>{
        points.push((0, _mainHelpers.zipToObj)(xs, ys1));
    });
    const dataObj = {
        datasets: []
    };
    let colors_ = false;
    if (colors.length !== 0) colors_ = true;
    points.forEach((val, index)=>{
        let color = "blue";
        if (colors_ && colors[index]) color = colors[index];
        else color = "blue";
        let ob = {
            data: val,
            pointRadius: 4,
    ...
    two = new (0, _chartJs.Chart)("2D", chartObj);
}

},{"chart.js":"d3eK4","./mainHelpers":"5zkm6","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku","7e126c47f8f88c31":"8igDv"}],"d3eK4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./chunks/helpers.segment.mjs":"SiqvY","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"SiqvY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"5zkm6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCol", ()=>getCol);
parcelHelpers.export(exports, "range", ()=>range);
parcelHelpers.export(exports, "zipToObj", ()=>zipToObj);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"8igDv":[function(require,module,exports) {
let workerURL = require("./helpers/get-worker-url");
let bundleURL = require("./helpers/bundle-url");
let url = bundleURL.getBundleURL("gnRNX") + "plotWorker.af10945a.js" + "?" + Date.now();
module.exports = workerURL(url, bundleURL.getOrigin(url), false);

},{"./helpers/get-worker-url":"lwj1n","./helpers/bundle-url":"28iTF"}],"jixf9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "workerMean", ()=>workerMean);
let header = [];
let basicstats = [];
function* calcMeans() {
    ...
    let index = 0;
    while(index !== key.length)if (meta[key[index]] === "number") yield this.Pdata.data[key[index] + 1];
}
...
let index = 0;
function workerMean() {
    let work = new Worker(require("a543bdb3339addaf"));
    if (meta === undefined) {
        basicstats = [];
        header = [];
        meta = this.Pdata.meta;
        key = Object.keys(meta);
        for(let k in key)if (meta[k] === "number") nums.push(+k);
    }
...
function median(cols) {
    const work = new Worker(require("a543bdb3339addaf"));
    work.postMessage({
        type: "med",
        data: cols
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku","a543bdb3339addaf":"4IaXF"}],"4IaXF":[function(require,module,exports) {
let workerURL = require("./helpers/get-worker-url");
let bundleURL = require("./helpers/bundle-url");
let url = bundleURL.getBundleURL("gnRNX") + "statsWorker.97c38aa9.js" + "?" + Date.now();
module.exports = workerURL(url, bundleURL.getOrigin(url), false);

},{"./helpers/get-worker-url":"lwj1n","./helpers/bundle-url":"28iTF"}],"fzRHf":[function(require,module,exports) {
let workerURL = require("./helpers/get-worker-url");
let bundleURL = require("./helpers/bundle-url");
let url = bundleURL.getBundleURL("gnRNX") + "worker.0e8bc8ed.js" + "?" + Date.now();
module.exports = workerURL(url, bundleURL.getOrigin(url), false);

},{"./helpers/get-worker-url":"lwj1n","./helpers/bundle-url":"28iTF"}],"8zqJo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _plots = require("./plots");
class Hist {
    constructor(bin, data){
        ...
        this.y = undefined;
        this.type = "Hist";
        (0, _plots.make_histogram)(data, bin).then((hist)=>{
            this.histObj = hist;
    ...
    freq(n) {
        if (this.histObj[n]) return this.histObj[n];
...
},{"./plots":"520zh","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"5xvI1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _chartJs = require("chart.js");
(0, _chartJs.Chart).register((0, _chartJs.BarController), (0, _chartJs.CategoryScale), (0, _chartJs.LinearScale), (0, _chartJs.BarElement), (0, _chartJs.ScatterController), (0, _chartJs.PointElement), (0, _chartJs.LineElement));
class Plot {
    static Hist(colors, ...bars) {
        ...
        div.appendChild(c);
        document.body.appendChild(div);
        this.barChart = new (0, _chartJs.Chart)(c.id, {
            type: "bar",
            data: dataObj
        });
    }
...
},{"chart.js":"d3eK4","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"en4he":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function SetAttribs(node, attrs) {
    for (const [key, val] of Object.entries(attrs))if (key === "onclick" || key === "change") node.addEventListener("click", val);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"15V4i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "toolbar", ()=>toolbar);
const toolbar = (toggleB)=>({
        tag: "div",
        attrs: {
            class: "toolbar"
        },
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"bA5Dk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "tools", ()=>tools);
//import {Pub, ob} from "../PubSub"
//console.log(Pub)
const topC = (Pub1)=>[
        {
            tag: "input",
        ...
        },
        {
            ...
            attrs: {
                class: "btn btn-1",
                onclick: ()=>Pub1.notify("tools", "shape")
            },
            children: [
                "Shape"
            ]
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"bMumQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Pub", ()=>Pub);
function pub() {
    class pubSub {
        constructor(name){
            this.name = name;
        ...
        subcribers = {};
        subcribe(channel, fn) {
            if (!this.subcribers[channel]) this.subcribers[channel] = [];
            this.subcribers[channel].push(fn);
            return ()=>{
                this.subcribers = this.subcribers.filter((sf)=>sf !== fn);
            };
        }
        notify(channel, ...data) {
            if (!this.subcribers[channel]) throw new Error(`${channel} does not exist`);
            this.subcribers[channel].forEach((fn)=>fn(...data));
        }
    }
    console.log("creating new Pub");
    return new pubSub("main");
}
const Pub = pub();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"geu6O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"cjoYh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "toolSub", ()=>toolSub);
var _bokkeJs = require("bokke.js");
var _bokkeJsDefault = parcelHelpers.interopDefault(_bokkeJs);
var _utils = require("../../utils");
var _table = require("../table");
const toolSub = (Pub, app, cache)=>{
    // cases for GUI tools selectionx
    // seperate to it's own file
    let mainFrame;
    let editedFrame;
    let toolsUnsub = Pub.subcribe("tools", (...data)=>{
        console.log(data);
        if (data[0] === "file") {
            console.log("file it is");
            (0, _bokkeJsDefault.default)(data[1], (frame)=>{
                mainFrame = frame;
                const t = (0, _utils.createElement)((0, _table.table));
                t.innerHTML = frame.table;
                app.appendChild(t);
                // console.log(frame)
                cache["app"] = app.innerHTML;
            });
        } else if (data[0] === "shape") {
            if (mainFrame) {
                // col and rows
                console.log(mainFrame.shape);
                Pub.notify("createEl", "log", mainFrame.shape);
            } else console.log("No frame yet");
        }
    //  console.log('f cga')
    });
    return toolsUnsub;
...
},{"bokke.js":"dqDZC","../../utils":"en4he","../table":"geu6O","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}],"d4mCV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createElSub", ()=>createElSub);
var _utils = require("../../utils");
const log = (data)=>({
        tag: "div",
        attrs: {
...
const createElSub = (Pub, app, cache)=>{
    let creatElunsub = Pub.subcribe("createEl", (...data)=>{
        console.log(data);
        if (data[0] === "log") {
            console.log("in log");
            app.appendChild((0, _utils.createElement)(log(data[1])));
        }
    });
    return creatElunsub;
};

},{"../../utils":"en4he","@parcel/transformer-js/src/esmodule-helpers.js":"2mdku"}]},["2s5bM","gLLPy"], "gLLPy", "parcelRequire58f5")
